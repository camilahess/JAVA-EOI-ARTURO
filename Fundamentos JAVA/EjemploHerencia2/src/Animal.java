...
//si en Animal que es la clase base, implemento la interfaz, todos los que hereden
// de la clase ANIMAL también heredan la interfaz
public abstract class Animal implements IHablador {
    ...
    public void comer(){ // Comportamiento por defecto
        //El animal cuando come engorda entre 0 y 0,5 kilos
     ...
     * a implementar el método si o sí. (@Override)
