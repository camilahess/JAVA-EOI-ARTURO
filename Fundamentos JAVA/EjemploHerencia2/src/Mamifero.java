...
public class Mamifero extends Animal{
    ...
    public void comer() {
        ...
        super.comer(); // Ejectuta el método de la clase base y le agregamos otra instruccion abajo

        System.out.println("He comido: " + (carnivoro ? "carne" : "hierba")); //Si es carnivoro (true), sino, (false) es hierba
}
